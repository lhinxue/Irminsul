    ...
    cipher: (objData, strKey, onSucceed = e => console.log(e), onFail = e => console.error(e)) => {
        ...
        try {
            ...
            if (objData.constructor.name === 'String') {
                ...
                var strResult = BINARY16(arrTemp.map((char, i) => XOR(char, arrKeyPro[i % intKeyProLength])))
                ...
                var arrTemp = BINARY16(strTemp)
                var strResult = BINARY16(arrTemp.map((char, i) => XOR(char, arrKey[i % intKeyLength])))
